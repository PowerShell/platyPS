        ...
        else 
        {
            ...
            $iterator | ForEach-Object {
                ...
                else # 'FromMaml'
                {
                    ...
                    GetMamlObject -MamlFile $_ -ConvertNotesToList:$ConvertNotesToList | ProcessMamlObjectToFile
...
function GetMamlObject
{
    ...
    {
        $HelpCollection = Get-HelpPreview -Path $MamlFile -ConvertNotesToList:$ConvertNotesToList
